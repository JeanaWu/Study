...
public class FindDetail extends Mypanel{
	...
	public FindDetail() {
		...
		myButton.setText("继续交易");
		myButton.setFont(new Font("幼圆", Font.BOLD, 30));
	...
	private class ComboBoxListener implements ActionListener{
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			if(this.jb.getSelectedItem().equals("三个月内"))  table.setModel(FindDetail.this.model_3month);
			if(this.jb.getSelectedItem().equals("一年内"))    table.setModel(FindDetail.this.model_1year);
		    if(this.jb.getSelectedItem().equals("三年内"))    table.setModel(FindDetail.this.model_3year);
